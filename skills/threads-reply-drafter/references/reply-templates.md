...
counterpart said and what you want the reply to do. Em dashes capped (a reply
is short, so at most one, and none if it reads fine without); use `..` for
soft pauses. Keep it warm, this is Threads.
